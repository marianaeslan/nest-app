...
interface ProjectRepository {
    ...
    suspend fun getOverview(): Result<List<ProjectSummary>>
    suspend fun getById(id: String): Result<ProjectResponse>
    suspend fun create(request: ProjectRequest): Result<ProjectResponse>
    suspend fun update(id: String, request: ProjectRequest): Result<ProjectResponse>
}